...
export const metadata: Metadata = {
  title: "RefreshBrand - Premium Alternative Beverages",
  description: "Discover innovative, natural beverages with zero compromise on taste or sustainability. Refresh your moments with RefreshBrand.",
  keywords: "alternative beverages, natural drinks, sustainable packaging, premium drinks, healthy options",
  metadataBase: new URL("https://refreshbrand.com"),
  alternates: {
    canonical: "https://refreshbrand.com"
  },
  openGraph: {
    title: "RefreshBrand - Premium Alternative Beverages",
    description: "Discover innovative, natural beverages crafted for every moment.",
    url: "https://refreshbrand.com",
    siteName: "RefreshBrand",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/tmp/refreshing-beverage-glass-ice-cold-drink-1764682683115-39b79a3f.jpg",
  ...
  twitter: {
    ...
    title: "RefreshBrand - Refresh Your Moments",
    description: "Premium natural beverages with sustainability at heart",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/tmp/colorful-drink-bottles-vibrant-beverages-1764682686278-27255904.jpg"]
  },
  robots: {
    index: true,
    follow: true
